const About = () => {
  ...
  return (
    <main style={{ margin: '40px auto', fontSize: '18px', lineHeight: '1.6', maxWidth: '800px' }}>
      ...
      <p style={fontStyle}>Furthermore, I have developed <a href="https://apps.apple.com/au/app/healthtonic-health-tracker/id6496689413" style={{ textDecoration: 'none', color: 'blue' }}>HealthTonic</a>, an iOS application available on the App Store. This app is designed for detailed tracking of calories, steps, water intake, and weight, featuring personalized UI, barcode scanning, and integration with the Health app.</p>
      <p style={fontStyle}>Feel free to explore my projects and connect with me if you have any questions or suggestions. Visit my <a href="https://github.com/theonlyanish" style={{ textDecoration: 'none', color: 'blue' }}>GitHub</a> to see more of my work or check out my coding snippets on <a href="https://codepen.io/akap0009" style={{ textDecoration: 'none', color: 'blue' }}>CodePen</a>.</p>
    </main>
  );
};
